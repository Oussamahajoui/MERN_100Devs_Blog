...
const UpdatePost = () => {
    ...
    return (
        <div className="p-3 max-w-3xl mx-auto min-h-screen">
            <h1 className="text-center text-5xl font-bold my-5">Update post</h1>
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-4 sm:flex-row justify-between">
                    ...
                    <select className="select select-bordered" onChange={(e) => setFormData({ ...formData, category: e.target.value })} value={formData.category}>
                ...
                <button type="submit" className="btn btn-block btn-outline">Update Post!</button>
