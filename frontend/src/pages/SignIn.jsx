...
const SignIn = () => {
    ...
    return (
        <div className="flex flex-col h-screen">
            <p className="text-6xl font-bold text-center pt-4">Sign-in Page</p>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            </label>
                            {
                                loading ? (<button className="btn btn-outline btn-block">
                                    ...
                                    loading
                                </button>) : (<button type="submit" className="btn btn-block btn-outline">Sign In</button>)
                            }
                            <OAuth />
                        </form>
                        <p className="text-sm mt-1">New around here? <Link to='/sign-up' className=" font-bold hover:text-gray-500 cursor-pointer ">Sign-up</Link></p>
                    </div>
                    {errorMessage && (
